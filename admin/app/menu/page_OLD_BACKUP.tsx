...
type MenuItem = {
  ...
  href: string;
  children?: MenuItem[];
  hasSubMenu?: boolean; // Flag to indicate if this child has its own sub-menu
};
            ...
            <div key={child.id} className="rounded-xl bg-white p-3 shadow-sm">
              <div className="flex flex-wrap items-center gap-2">
                <input
                  ...
                  value={child.label}
                  onChange={(event) =>
                    onChangeChild(index, { label: event.target.value })
                  }
                  placeholder="Label"
                />
                <input
                  ...
                  {(child.children || []).map((subChild, subIndex) => (
                    ...
                    >
                      <input
                        ...
                        onChange={(event) =>
                          onChangeSubChild(index, subIndex, { label: event.target.value })
                        }
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4 text-white">
          ...
          <div className="hidden md:block">
            <span className="inline-flex flex-col items-center rounded-full bg-[#ffd200] px-5 py-2 text-[11px] font-semibold text-[#052a5f]">
              <EditableText
                value={menu.cta?.label || "Book Appointment"}
...
export default function MenuBuilder() {
  ...
  const addItem = () => {
    ...
    setMenu({
      ...
      items: [
        ...menu.items,
        { id: crypto.randomUUID(), label: "New Item", href: "/", children: [] },
      ],
    });
  };
          ...
          <div className="grid gap-6">
            <NavbarPreview
              ...
              onCtaLabelChange={(value) =>
                setMenu({
                  ...menu,
                  cta: { label: value, href: menu.cta?.href || "" },
                })
              }
                    ...
                    {(menu.contactBar.items || []).map((item, index) => (
                      ...
                      >
                        ...
                        <input
                          ...
                          value={item.text}
                          onChange={(event) =>
                            updateContactItem(index, { text: event.target.value })
                          }
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
              ...
              <div className="mt-3 grid gap-3 sm:grid-cols-2">
                <input
                  ...
                  value={menu.cta?.label || ""}
                  onChange={(event) =>
                    setMenu({
                      ...menu,
                      cta: { label: event.target.value, href: menu.cta?.href || "" },
                    })
                  }
                ...
                <input
                  ...
                  onChange={(event) =>
                    setMenu({
                      ...menu,
                      cta: { label: menu.cta?.label || "", href: event.target.value },
                    })
                  }
